...
class NewThread implements Runnable {
	// public static HashMap<String,String> FileManager=new
	// HashMap<String,String>();
	// public static Multimap<Integer,String> FileManager =
	...
	public void run() {
		...
		try {
			...
			do {
				...
				case "pwd":
					// output.writeUTF("Remote working directory: " +
	...
	void get(String fileName, String presentWD, int commandID) {
		try {
			...
			// dis.readFully(buffer, 0, buffer.length); // readfully is required to read all
			// at once
